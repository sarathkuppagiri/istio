...
This example shows you how to injects an HTTP delay fault to test the resiliency of your application.
...
kubectl apply -f helloworld-delay-gateway.yaml --namespace demo-istio
...
```
  ...
  It returns the response in configured delay time.
